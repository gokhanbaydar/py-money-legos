...
soloMarginAbi = util.read_json("./dydx/abi/SoloMargin.json")
payableProxyForSoloMarginAbi = util.read_json(
    "./dydx/abi/PayableProxyForSoloMargin.json"
)
polynomialInterestSetterAbi = util.read_json("./dydx/abi/PolynomialInterestSetter.json")
expiryAbi = util.read_json("./dydx/abi/Expiry.json")
expiryV2Abi = util.read_json("./dydx/abi/ExpiryV2.json")
daiPriceOracleAbi = util.read_json("./dydx/abi/DaiPriceOracle.json")
saiPriceOracleAbi = util.read_json("./dydx/abi/SaiPriceOracle.json")
wethPriceOracleAbi = util.read_json("./dydx/abi/WethPriceOracle.json")
usdcPriceOracleAbi = util.read_json("./dydx/abi/UsdcPriceOracle.json")
adminImplAbi = util.read_json("./dydx/abi/AdminImpl.json")
operationImplAbi = util.read_json("./dydx/abi/OperationImpl.json")
liquidatorProxyV1ForSoloMarginAbi = util.read_json(
    "./dydx/abi/LiquidatorProxyV1ForSoloMargin.json"
)
limitOrdersAbi = util.read_json("./dydx/abi/LimitOrders.json")
stopLimitOrdersAbi = util.read_json("./dydx/abi/StopLimitOrders.json")
canonicalOrdersAbi = util.read_json("./dydx/abi/CanonicalOrders.json")
signedOperationProxyAbi = util.read_json("./dydx/abi/SignedOperationProxy.json")
refunderAbi = util.read_json("./dydx/abi/Refunder.json")
